...
csv_file_names = []
with open("/home/domingom/projects/UOC/CNN_Primer_Off-Target_Rate_Prediction_project/dada/csv_align_ONLYnames.txt") as f:
    for line in f:
...
for name in tqdm(csv_file_names, desc='processing the file'):
    ...
    #Load data. Alignments and epcr07 files already concatenated.
    alignments_file = f'/home/domingom/projects/UOC/CNN_Primer_Off-Target_Rate_Prediction_project/dada/raw/{name}_alignments.csv'
    combined_data = pd.read_csv(alignments_file, sep=",")
    ...
    combined_data = combined_data[combined_data.ne(combined_data.columns).any(axis=1)]
    combined_data['umi_groups_cnt'] = combined_data['umi_groups_cnt'].astype(int)
    ...
    save_report(
        report,
        output_dir=Path(f"/home/domingom/projects/UOC/CNN_Primer_Off-Target_Rate_Prediction_project/reports/{name}_data_quality_reports_01f"),
    ...
    npz_folder = "/home/domingom/projects/UOC/CNN_Primer_Off-Target_Rate_Prediction_project/dada/processed/images_labels_CollapsedAlign01f_npz"
    ...
    metadata = {
        ...
        "off_value": OTHER_VAL,
        "encoding_script_version": "01f_align_collap_encode_and_metadata.py",
