...
class Config:
    ...
    def __post_init__(self):
        self.data_test_dir = self.project_root / "dada" / "hold_out_test_data"  
        self.data_dir = self.project_root / "dada" / "processed" / "images_labels_CollapsedAlign01f_npz"
        self.data_dir_dhs001z = self.project_root / "dada" / "need_to_be_combined" / "processed" / "images_labels_CollapsedAlign_npz" 
