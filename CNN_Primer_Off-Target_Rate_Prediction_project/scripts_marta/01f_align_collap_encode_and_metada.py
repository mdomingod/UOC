...
for name in tqdm(csv_file_names, desc='processing the file'):
    ...
    alignments_file = f'/home/domingom/projects/SPE_Primer_Alignments/data/raw/{name}_alignments.csv'
    ...
    save_report(
        report,
        output_dir=Path(f"/home/domingom/projects/SPE_Primer_Alignments/reports/from_01f_alreadyCombined/{name}_data_quality_reports_01f"),
    ...
    npz_folder = "/home/domingom/projects/SPE_Primer_Alignments/data/processed/images_labels_CollapsedAlign01f_npz"
