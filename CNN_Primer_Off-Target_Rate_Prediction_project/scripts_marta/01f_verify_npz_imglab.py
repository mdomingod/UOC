...
csv_file_names = []
with open("/home/domingom/projects/SPE_Primer_Alignments/data/images_name_npz.txt") as f:
    for line in f:
...
for name in tqdm(csv_file_names, desc='processing the file'):
    ...
    verify_dataset(f"/home/domingom/projects/SPE_Primer_Alignments/data/processed/images_labels_CollapsedAlign01f_npz/{name}")